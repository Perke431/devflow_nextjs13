    ...
    return (
        <div className='relative w-full max-w-[600px] max-lg:hidden'>
            <div
                ...
                <Input type='text' placeholder='Search globaly' value='' className='paragraph-regular no-focus placeholder background-light800_darkgradient border-none shadow-none outline-none' />
            </div>
        </div>
    )
}
